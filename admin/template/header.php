...
<head>
    ...
    <?php
		...
		get_scripts_backend();
	?>
	<script type="text/javascript" src="template/js/jquery.getsimple<?php $lang_short = get_site_lang(true);if ($lang_short == 'ru') {echo '-ru';} ?>.js?v=<?php echo GSVERSION; ?>"></script>
	...
	<script type="text/javascript">		
		...
		jQuery(document).ready(function() { 
			...
			?>
				...
				if(verstatus != 1) {
					<?php if(isBeta()){ ?> $('a.support').parent('li').append('');
					<?php } else { ?> $('a.support').parent('li').append(''); <?php } ?>
