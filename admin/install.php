...
get_template('header', $site_full_name.' CMS &raquo; '. i18n_r('INSTALLATION') ); 
...
?>
	...
	<div id="maincontent">
	<div class="main" >
	<h3><?php echo $site_full_name .' CMS '. i18n_r('INSTALLATION'); ?></h3>
			...
			if ($verstatus == '0') {
				$ver = '<span class="ERRmsg" >'. i18n_r('UPG_NEEDED') .' <b>'.$apikey->latest .'</b></span>';
			} elseif ($verstatus == '1') {
				$ver = '<span class="OKmsg" ><b>'.$site_version_no.'</b></span>';
			} elseif ($verstatus == '2') {
				$ver = '<span class="OKmsg" ><b>'.$site_version_no.'</b></span>';
			} else {
				$ver = '<span class="OKmsg" >'. i18n_r('CANNOT_CHECK') .' <b>'.$site_version_no.'</b></span>';
			}
			?>
			...
			<form action="setup.php" method="post" accept-charset="utf-8" >
				<div class="leftsec" style="width:100%">
					<p>			
						<?php echo $langs; ?>
						<!--<a href="http://get-simple.info/docs/languages" target="_blank" ><?php i18n('DOWNLOAD_LANG');?></a>
